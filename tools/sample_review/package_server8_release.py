...
SAMPLE_REVIEW_FILES = frozenset(
    {
        ...
        "tools/sample_review/gpu_dashboard.py",
        "tools/sample_review/door_review.py",
        "tools/sample_review/collect_door_review.py",
        "tools/sample_review/sync_worker.py",
        "tools/sample_review/gpu_probe.py",
        "tools/sample_review/ai-bot-gpu-dashboard-server8.service",
        "tools/sample_review/ai-bot-gpu-dashboard-server8.timer",
