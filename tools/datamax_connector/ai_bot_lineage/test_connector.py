...
def request():return {"protocol":"managed_connector_process/v1","connector_key":"ai_bot_lineage","connector_version":"1.0.0","operation":"sync","request_id":"r1","settings":{"api_base_url":"http://127.0.0.1:8793","algorithm_key":"takeaway_uniform"},"resource_id":"takeaway_uniform","limit":100}
